...
struct ChatTableViewLocationCellModel: ChatTableViewCellModel {
    ...
    // MARK: - Init
    init(locationItem: LocationItem, timestamp: Date, profileImage: UIImage?, isMessageRead: Bool, isIncomingMessage: Bool, isMessageEdited: Bool,  chatType: ChatType, needHideMessage: Bool) {
