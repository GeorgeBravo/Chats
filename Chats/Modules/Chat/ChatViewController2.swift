...
////}
//
//final class ChatViewController2: MockViewController {
//
...
//            return NSAttributedString(string: MessageKitDateFormatter.shared.string(from: message.sentDate), attributes: [NSAttributedString.Key.font: UIFont.boldSystemFont(ofSize: 14), NSAttributedString.Key.foregroundColor: UIColor.blackTwo])
//        }
//        return nil
//    }
//
...
//    }
//
//    override func didTapAttachmentsButton(_ inputBar: InputBarAccessoryView) {
...
//    }
//
//    override func didTapAudioButton(_ inputBar: InputBarAccessoryView) {}
//}
//
...
//// MARK: - MessagesDisplayDelegate
//
//extension ChatViewController2: MessagesDisplayDelegate {
//
//    // MARK: - Text Messages
//
...
//        return isFromCurrentSender(message: message) ? UIColor.coolGrey : UIColor.paleGrey
//    }
//
...
//// MARK: - MessagesLayoutDelegate
//
//extension ChatViewController2: MessagesLayoutDelegate {
//
...
//}
//
//extension ChatViewController2: ChatPresentable {}
//
//extension ChatViewController2: ChatViewControllable {}
//extension ChatViewController2: BackButtonSettupable {}
//extension ChatViewController2: CollocutorNavBarSettupable {}
